...
Note that with the check_type() function a column also needs to be defined, due to the simplicity of the example this is not possible in the example. So your code will look like check_type(example$column).
