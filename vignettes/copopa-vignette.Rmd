...
* It makes checking datatypes on data with a lot of values quick.
* It easily saves a dataframe into two different files, CSV and RDS.

Checking datatypes is done by the "check_type(x)" function. Enter target data as x and you'll receive a list of types per value.
