...
Checking datatypes is done by the "multi_check(x, y, z)" function. Enter target data as x, y and z and you'll receive a list of types per data set. If you want to check a column of a set enter x$column.
